...
class Enhanced_Display:
    ...
    # My additional utility functions for generic displaying text and images on ssd1305 based OLED displays
    def show_msg(self, text):
        self.fill(0)
        self.select_font(None)
